        ...
        <div *ngIf="dpTab==='info'">
          ...
          <div class="info-row">
            ...
            <span class="info-val" style="color:var(--orange);font-family:'Sora',sans-serif;font-size:15px;font-weight:700">
              {{ (selected.value_pln||0) | number:'1.0-0' }} PLN
            </span>
          </div>
          <div class="info-row">
...
<div class="overlay" *ngIf="showNew" (click)="showNew=false">
  ...
  styles: [`
    ...
    /* Kanban */
    .kanban-wrap { display:flex; flex:1; overflow:hidden; min-height:0; gap:0; }
    .kanban { display:grid; grid-template-columns:repeat(6,1fr); gap:12px; flex:1; overflow-y:auto; align-items:start; padding-bottom:8px; }
    .kol { min-width:0; }
    ...
    /* Detail Panel */
    .detail-panel { width:340px; flex-shrink:0; border-left:1px solid var(--gray-200); background:white; display:flex; flex-direction:column; overflow:hidden; animation:slideIn .18s ease; }
